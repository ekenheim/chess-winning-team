...
|---|---|---|---|---|---|---|---|---|
| `sep25-erik` | windows-i7-13700H | 3 | 3 | **1985** ±144 (eval: tapered evaluation by non-pawn material phase) | 1785 ±144 | 1800 | 8 | 1 |
| `sep25-robin` | macos-m1pro | 3 | 1 | **1915** ±176 (baseline) | — | 1600 | 0 | 0 |
